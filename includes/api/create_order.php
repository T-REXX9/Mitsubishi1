    ...
    if ($input['client_type'] === 'handled') {
        ...
        $stmt = $connect->prepare("
            INSERT INTO orders (
                ...
                total_unit_price, nominal_discount, promo_discount, amount_to_invoice,
                amount_finance, finance_percentage, down_payment_percentage, net_down_payment,
                insurance_premium, cptl_premium, lto_registration, chattel_mortgage_fee,
                chattel_income, extended_warranty, total_incidentals, reservation_fee, total_cash_outlay,
